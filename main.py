...
print ("""3. Copy - copies list reference if assigned to a another list variable. e.g. list = list1 will only copy the reference. Any changes to list will also be made to list1.
